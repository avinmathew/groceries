...
If done from the Main interface, it refreshes all groceries that aren't crossed out. Prices are shown to the user as soon as they are refreshed per product link.
